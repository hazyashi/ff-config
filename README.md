...
please dont judge me i am just a stupid creature with a dream.<br>
...
` cd fastfetch-config `<br>
` cp config.jsonc ~/.config/fastfetch `<br>
if you want the image then also copy the image here, otherwise set the source to "auto" for a distro ascii art.
